...
##
# Handle onboarding PSK and SSID for HAWKEYE/AKRONITE/DAKOTA/MAPLE_PINE_PINE/HAWKEYE_PINE/ALDER_PINE_PINE/OS_EXTENDER_QCA53
# targets.
#
...
ifneq ($(filter HAWKEYE HAWKEYE_RDP419 HAWKEYE_PINE AKRONITE DAKOTA MAPLE_PINE_PINE ALDER_PINE_PINE OS_EXTENDER_QCA53,$(TARGET)),)
