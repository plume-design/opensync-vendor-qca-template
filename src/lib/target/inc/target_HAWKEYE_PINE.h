#ifndef TARGET_HAWKEYE_PINE_H_INCLUDED
#define TARGET_HAWKEYE_PINE_H_INCLUDED
...
#define TARGET_ETHCLIENT_IFLIST     "eth0", "eth1", "eth2", "eth3"
...
#endif /* TARGET_HAWKEYE_PINE_H_INCLUDED */
